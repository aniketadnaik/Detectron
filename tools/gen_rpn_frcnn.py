...
"""This scripts generate region proposal file using fastre rcnn and results 
are stroed in a pickle file.
Expects environment variable CAFFE2_HOME to be set to valid caffe2 distrbution
Requires setting '__C.MODEL.FASTER_RCNN = True' in detectron/core/config.py in order
make use of faster rcnn. Configuration is set programitically in the code below.
"""
